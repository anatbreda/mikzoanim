...
(function () {
  ...
  function warningHtml(w) {
    ...
    if (w.type === 'nomedia') {
      return '<div class="notice">' + w.count + ' כרטיסי איש קשר הופיעו בצ׳אט אבל הקבצים ' +
        'עצמם לא נכללו בייצוא, ולכן אין להם מספר טלפון. כדאי לייצא שוב עם ' +
        '<strong>צירוף מדיה</strong>.</div>';
    }
    return '';
  }
  ...
  function screenImport() {
    ...
    mount(
      ...
      '<strong>צירוף מדיה</strong>. בלי צירוף מדיה לא יגיעו קבצי אנשי הקשר ' +
      'ולא יהיו מספרי טלפון.</p>' +
